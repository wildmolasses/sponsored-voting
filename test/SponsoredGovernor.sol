...
contract SponsoredGovernor is GovernorVotes, GovernorCountingSimple, GovernorSponsoredVoting {
  constructor(string memory _name, IVotes _token, IEntryPoint _entryPoint)
    payable
